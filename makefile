...
compile: main.cpp
	g++ -I . -pthread -o cmake-build-debug/21S_CS3377_Project main.cpp FileModifierFactory.cpp Part1SimpleFileModifier.cpp Part2MultiProcessModifier.cpp Part3ThreadedModifier.cpp Part4SocketModifier.cpp PipeMaker.cpp Util.cpp FileReader.cpp FileWriter.cpp ModifyFile.cpp
